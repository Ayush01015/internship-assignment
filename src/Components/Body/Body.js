    ...
    <div className="body">
      <div className="section section-1">
        ...
        <div className="transactions-container">
          <div className="sub-section sub-section-mt">
        ...
        <div className="sub-section  goals-container">
          <div className="goal-flex">
            <div className="goals">
              ...
              <span className="text-sm gl">My Goals</span>
        ...
        <div className="sub-section contributions-container">
          ...
          <div className="sub-cotribution-container">
            ...
            <div className="mt-1 contro">
              <div className="style-hr style-hr-1"></div>
            ...
            <div className="mt-1 contro">
              <div className="style-hr style-hr-2"></div>
              <div className="contro-flex">
            ...
            <div className="mt-1 contro">
              <div className="style-hr style-hr-3"></div>
              <div className="contro-flex">
                <p className="text-sm">Total Interest</p>
      ...
      <div className="container">
        ...
        <div className="extras">
          ...
          <div className="extra-width">
            <p>
              Are you considering a having{" "}
              <span className="bold">Housing Advance?</span>{" "}
            </p>
